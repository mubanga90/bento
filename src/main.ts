...
<div id="grid">
 <div class="item" data-min-width="4" data-min-height="4">Item 1</div>
 <div class="item" data-min-width="6" data-min-height="6">Item 2</div>
 <div class="item" data-min-width="1" data-min-height="1">Item 3</div>
 <div class="item" data-min-width="4" data-min-height="1">Item 4</div>
 <div class="item" data-min-width="2" data-min-height="3">Item 5</div>
 <div class="item" data-min-width="2" data-min-height="1">Item 6</div>
</div>
`;
